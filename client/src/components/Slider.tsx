...
export const Slider: FC<SliderComponentProps> = (props) => {
    const { label, placeholder, caption, maxLength, disabled, value, min, max, onChange, className, units } = props;
            ...
            <div className={classes.inputGroup}>
                ...
                <div className={classes.sliderWrapper}>
                    <ReactSlider
                        ...
                        max={max}
                        min={min}
                        railStyle={{ backgroundColor: theme.colors.divider.base.backgroundColor, height: 2 }}
                        trackStyle={{ backgroundColor: theme.colors.primary.base.backgroundColor, height: 2 }}
                        handleStyle={{
