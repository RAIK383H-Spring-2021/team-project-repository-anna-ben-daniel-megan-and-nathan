...
export const Stepper: FC<StepperComponentProps> = (props) => {
    ...
    return (
        <div className={`${classes.wrapper} ${props.className}`}>
            ...
            />
            <div className={`${classes.stepperLine} ${props.disabled[1] ? classes.disabled : classes.primary}`} />
            <StepperNode
                icon="group_add"
            ...
            />
            <div className={`${classes.stepperLine} ${props.disabled[2] ? classes.disabled : classes.primary}`} />
            <StepperNode
                icon="send"
                label="Send Invites"
                active={activeNode === 2}
